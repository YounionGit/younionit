...
!function (a, b) {
      ...
      if (!e && p) {
        if (11 !== k && (f = _.exec(a)))if (j = f[1]) {
          if (9 === k) {
            ...
            if (b.ownerDocument && (h = b.ownerDocument.getElementById(j)) && t(b, h) && h.id === j)return d.push(h), d
        } else {
      ...
      return 1 === d && 0 === e ? function (a) {
        ...
        if (q) {
          ...
          if (o = [g ? q.firstChild : q.lastChild], g && s) {
            ...
            if (s && (j = (b[u] || (b[u] = {}))[a]) && j[0] === w)m = j[1]; else while (l = ++n && l && l[p] || (m = n = 0) || o.pop())if ((h ? l.nodeName.toLowerCase() === r : 1 === l.nodeType) && ++m && (s && ((l[u] || (l[u] = {}))[a] = [w, m]), l === b))break;
  ...
  K.uid = 1, K.accepts = n.acceptData, K.prototype = {key : function (a) {
    ...
    if ("string" == typeof b)f[b] = c; else
      if (n.isEmptyObject(f))n.extend(this.cache[e], b); else for (d in b)f[d] = b[d];
    return f
  }, get                                                  : function (a, b) {
  ...
  n.extend({clone  : function (a, b, c) {
    ...
    for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [], m = 0, o = a.length; o > m; m++)if (e = a[m], e || 0 === e)if ("object" === n.type(e))n.merge(l, e.nodeType ? [e] : e); else
      if (cb.test(e)) {
  ...
  function Ac(a, b, c, d) {
    ...
    if (n.isArray(b))n.each(b, function (b, e) {
      ...
      if (c || "object" !== n.type(b))d(a, b); else for (e in b)Ac(a + "[" + e + "]", b[e], c, d)
  }
