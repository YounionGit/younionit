...
controlerApp.controller('LiberacaoController', function ($rootScope, $scope, $http, $location, $timeout) {
  ...
  $scope.liberarMes = function () {
    $http.post('/controle/liberacao/salvar', {data : $scope.data, id_usuario : $scope.colaborador.id_usuario }).success(function (res) {
      $scope.showMsg = true;
  ...
  $scope.bloquearMes = function () {
    $http.post('/controle/liberacao/bloquear', {data : $scope.data, id_usuario : $scope.colaborador.id_usuario }).success(function (res) {
