...
test('types', function (t) {
  t.test('\n# Boolean', function (t) {
    ...
    t.assertSurrounds('return true; return false;', { 'Boolean' : { 'false' : '#:', _default : '$:%' } }, 'return $true%; return #false%;')
    t.end()
  })
  t.test('\n# Identifier', function (t) {
    t.assertSurrounds('var a = 1;', { 'Identifier' : { _default : '$:%' } }, 'var $a% = 1;')
    t.assertSurrounds('var a = 1; const b = 2;', { 'Identifier' : { 'b' : '#:', _default : '$:%' } }, 'var $a% = 1; const #b% = 2;')
    t.end()
  })
  t.test('\n# Null', function (t) {
  ...
  t.test('\n# Numeric', function (t) {
    ...
    t.assertSurrounds('return 1; return 2;', { 'Numeric' : { '2' : '#:', _default : '$:%' } }, 'return $1%; return #2%;')
    t.end()
  })
  ...
  t.test('\n# String', function (t) {
    ...
    t.assertSurrounds('return "hello"; return "world";', { 'String' : { '"world"' : '#:', _default : '$:%' } }, 'return $"hello"%; return #"world"%;')
    t.end()
  })
})
