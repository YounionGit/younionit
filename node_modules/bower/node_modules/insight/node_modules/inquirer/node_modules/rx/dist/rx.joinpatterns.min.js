...
(function (a) {
  ...
  !f || f.global !== f && f.window !== f || (c = f), "function" == typeof define && define.amd ? define(["rx"], function (b, d) {
    ...
    e.prototype.and = function (a) {
      ...
      for (var d = this, e = [], f = 0, i = this.expression.patterns.length; i > f; f++)e.push(g(a, this.expression.patterns[f], b.onError.bind(b)));
      var j = new h(e, function () {
        ...
        for (var a = 0, b = e.length; b > a; a++)e[a].removeActivePlan(j);
        c(j)
      });
      for (f = 0, i = e.length; i > f; f++)e[f].addActivePlan(j);
      return j
