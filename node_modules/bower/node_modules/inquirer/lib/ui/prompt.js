...
PromptUI.prototype.processQuestion = function (question) {
  return rx.Observable.defer(function () {
    ...
    return obs.concatMap(this.setDefaultType).concatMap(this.filterIfRunnable.bind(this)).concatMap(utils.fetchAsyncQuestionProperty.bind(null, question, "default", this.answers)).concatMap(utils.fetchAsyncQuestionProperty.bind(null, question, "choices", this.answers)).concatMap(this.fetchAnswer.bind(this));
  }.bind(this));
};
