var SwitchObservable = (function (__super__) {
  ...
  SwitchObservable.prototype.subscribeCore = function (observer) {
    var innerSubscription = new SerialDisposable(), subscription = this.source.subscribe(new SwitchObserver(observer, innerSubscription));
...
var SwitchObserver = (function (__super__) {
  ...
  var InnerObserver = (function (__base__) {
    ...
    InnerObserver.prototype.next = function (x) {
      this.parent.latest === this.id && this.parent.observer.onNext(x);
    };
    InnerObserver.prototype.error = function (e) {
      this.parent.latest === this.id && this.parent.observer.onError(e);
    };
