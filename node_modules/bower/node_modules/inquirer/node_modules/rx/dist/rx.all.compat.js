...
(function (undefined) {
  ...
  var toString = Object.prototype.toString, hasOwnProperty = Object.prototype.hasOwnProperty, supportsArgsClass = toString.call(arguments) == argsClass, // For less <IE9 && FF<4
      supportNodeClass, errorProto = Error.prototype, objectProto = Object.prototype, stringProto = String.prototype, propertyIsEnumerable = objectProto.propertyIsEnumerable;
  try {
  ...
  if (!Function.prototype.bind) {
    Function.prototype.bind = function (that) {
      var target = this, args = slice.call(arguments, 1);
      var bound = function () {
  ...
  if (!Array.prototype.every) {
    Array.prototype.every = function every(fun /*, thisp */) {
      var object = Object(this), self = splitString && {}.toString.call(this) == stringClass ? this.split("") : object, length = self.length >>> 0, thisp = arguments[1];
  ...
  if (!Array.prototype.map) {
    Array.prototype.map = function map(fun /*, thisp*/) {
      var object = Object(this), self = splitString && {}.toString.call(this) == stringClass ? this.split("") : object, length = self.length >>> 0, result = Array(length), thisp = arguments[1];
      if ({}.toString.call(fun) != funcClass) {
        throw new TypeError(fun + " is not a function");
      }
      for (var i = 0; i < length; i++) {
    ...
    function invokeRecDate(scheduler, pair, method) {
      ...
      function recursiveAction(state1) {
        action(state1, function (state2, dueTime1) {
          var isAdded = false, isDone = false, d = scheduler[method](state2, dueTime1, function (scheduler1, state3) {
            if (isAdded) {
              group.remove(d);
            } else {
              isDone = true;
  ...
  var FromSink = (function () {
    ...
    FromSink.prototype.run = function () {
      var list = Object(this.parent.iterable), it = getIterable(list), observer = this.observer, mapper = this.parent.mapper;
  ...
  var combineLatest = Observable.combineLatest = function () {
    ...
    return new AnonymousObservable(function (o) {
      var n = args.length, falseFactory = function () {
        return false;
      }, hasValue = arrayInitialize(n, falseFactory), hasValueAll = false, isDone = arrayInitialize(n, falseFactory), values = new Array(n);
  ...
  observableProto['do'] = observableProto.tap = observableProto.doAction = function (observerOrOnNext, onError, onCompleted) {
    var source = this, tapObserver = typeof observerOrOnNext === 'function' || typeof observerOrOnNext === 'undefined' ? observerCreate(observerOrOnNext || noop, onError || noop, onCompleted || noop) : observerOrOnNext;
    return new AnonymousObservable(function (observer) {
      return source.subscribe(function (x) {
        try {
  ...
  var observableSpawn = Rx.spawn = function (fn) {
    ...
    return function (done) {
      ...
      if (isGenFun) {
        ...
        var len = args.length, hasCallback = len && typeof args[len - 1] === fnString;
  ...
  var ControlledSubject = (function (__super__) {
    ...
    addProperties(ControlledSubject.prototype, Observer, {
      ...
      onError               : function (error) {
        ...
        this.error = error;
        if (!this.enableQueue || this.queue.length === 0)
          this.subject.onError(error); else
  ...
  observableProto.partition = function (predicate, thisArg) {
    return [
      this.filter(predicate, thisArg), this.filter(function (x, i, o) {
