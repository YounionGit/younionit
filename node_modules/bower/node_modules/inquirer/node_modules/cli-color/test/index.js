...
module.exports = function (t, a) {
  var x, y;
  a(t('test'), 'test', "Plain");
  a(t('test', 'foo', 3, { toString : function () {
    return 'bar';
  ...
  a(t.bol(-2, true), '\x1b[0E\x1bK\x1b[1F\x1b[K\x1b[1F\x1b[K', "Bol: Erase: Negative");
  a(t.bol(2, true), '\x1b[1E\x1b[K\x1b[1E\x1b[K', "Bol: Erase: Positive");
  a(t.beep, '\x07', "Beep");
};
