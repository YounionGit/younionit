  ...
  function g(e) {
    ...
    function at(n, t, e, r, u, o) {
      ...
      if (u.push(n), o.push(t), p) {
        if (s = n.length, h = t.length, (a = h == s) || r)for (; h--;)if (p = s, g = t[h], r)for (; p-- && !(a = at(n[p], g, e, r, u, o));); else
    ...
    function st() {
      ...
      var u = [];
      if (Le.enumPrototypes && u.push('!(G&&n=="prototype")'), Le.enumErrorProps && u.push('!(F&&(n=="message"||n=="name"))'), e.j && e.f)r += "var C=-1,D=B[typeof t]&&v(t),u=D?D.length:0;while(++C<u){n=D[C];", u.length && (r += "if(" + u.join("&&") + "){"), r += e.g + ";", u.length && (r += "}"), r += "}"; else
        if (r += "for(n in t){", e.j && u.push("m.call(t, n)"), u.length && (r += "if(" + u.join("&&") + "){"), r += e.g + ";", u.length && (r += "}"), r += "}", Le.nonEnumShadows) {
    ...
    function Lt(n, t, e) {
      ...
      if (typeof t != "number" && null != t) {
        ...
        if (r = t, null == r || e)return n ? n[0] : h;
    ...
    function zt(t, e, r) {
      if (typeof r == "number") {
        ...
        if (r)return r = Kt(t, e), t[r] === e ? r : -1;
      return n(t, e, r)
    }
    ...
    return v.after = function (n, t) {
      ...
      if (typeof t != "number" && null != t) {
        ...
        if (r = t, null == r || e)return n ? n[u - 1] : h;
      return s(n, Be(0, u - r))
